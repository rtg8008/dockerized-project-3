...
exports.seed = async function(knex) {
  ...
  // 1.1 Reconnaissance - Reconnaissance Vehicles
    {name: 'BRDM-1', subcategory_id: 1, caliber: '12.7mm', max_range_meters: 2000, armored: true, country: 'Russian', image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/0/00/BRDM-1_TBiU_24_1.jpg/1280px-BRDM-1_TBiU_24_1.jpg'},
    {name: 'FOX Armored Scout Car', subcategory_id: 1, caliber: '30mm', max_range_meters: 1100, armored: true, country: 'British', image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/f/f2/FV721_Fox_armoured_fighting_vehicle_%282008-08-09%29.jpg/1024px-FV721_Fox_armoured_fighting_vehicle_%282008-08-09%29.jpg'},
    {name: 'EE-9 CASCAVEL', subcategory_id: 1, caliber: '90mm', max_range_meters: 2000, armored: true, country: 'Brazilians', image: 'https://photo.weaponsystems.net/image/s-carousel/n-ve_sct_ee-9_p01.jpg/--/img/ws/ve_sct_ee-9_p01.jpg'},
  // 1.2 Reconnaissance - Reconnaissance Systems
    ...
    {name: 'G3', subcategory_id: 3, caliber: '7.62x51mm NATO', max_range_meters: 400, armored: false, country: 'German', image: 'https://i.imgur.com/evP3BZ7.jpg'},
    ...
    {name: 'QBZ-95', subcategory_id: 3, caliber: '5.8×42mm', max_range_meters: 400, armored: false, country: 'Chinese', image: 'https://nationalinterest.org/sites/default/files/styles/hero-960w/public/main_images/QBZ95_automatic_rifle_20170902.jpg?itok=Te0IRvzr'},
  ...
  // 3.2 Infantry Vehicles - Infantry Fighting Vehicles
    ...
    {name: 'FNSS', subcategory_id: 9, caliber: '25mm', max_range_meters: 1500, armored: true, country: 'Turkish', image: 'http://www.armyrecognition.com/images/stories/europe/turkey/light_armoured/TIFV/TIFV_FNSS_light_armoured_infantry_combat_armoured_vehicle_Turkish_army_Turkey_640.jpg'},
  // 4.0 Tanks
    {name: 'TYPE 96 AND TYPE 96G', subcategory_id: 33, caliber: '125mm', max_range_meters: 1000, armored: true, country: 'Chinese', image: 'https://www.military-today.com/tanks/type_96_l7.jpg'},
  ...
  // 5.5 Anti-Tank / Anti-Tank Armor - ATGM Launcher Vehicles
    ...
    {name: '9P162/KORNET-LR', subcategory_id: 16, caliber: 'ATGM', max_range_meters: 5500, armored: false, country: 'Russian', image: 'https://www.military-today.com/missiles/kornet_t_s1.jpg'},
